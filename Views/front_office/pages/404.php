          ...
          <div class="row">
            ...
            <div class="col-sm-12 text-center">
              <header class="page-header highlight">
                <h3>404</h3>
                <p class="text-uppercase">Oops, page not found!</p>
                <h6>You can search what interested:</h6>
              </header>
              ...
              <div class="page-content">
                <div id="search-404" class="widget widget_search">
                  <form role="search" method="get" class="search-form" action="http://webdesign-finder.com/">
                    ...
                    <h6 class="page-header py-30">or</h6>
                    <p>
                      <a href="jobs.php" class="btn btn-outline-darkgrey">Jobs</a> <!-- ##### index CHANGE LINK #### -->
                    </p>
                  </form>
                </div>
              </div>
