      ...
      <div id="box_wrapper">
        ...
        <div class="container-fluid">
          <div class="container-fluid">
              <div class="card">
                  <div class="card-body">
                      <h5 class="card-title fw-semibold mb-4">demande d'ajout d'un article</h5>
                      <!-- Form for adding new job -->
                      <form action="./add_art_front.php" method="post">
                          <!-- job Information -->
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="auteur" name="auteur" placeholder="Enter the auteur"
                                  required>
                              <div id="auteur_error" style="color: red;"></div>
                          </div>
                          <div class="mb-3">
                              <label for="date_art" class="form-label">date_art</label>
                              <input type="date" class="form-control" id="date_art" name="date_art" placeholder="Enter the date"
                                  required>
                          ...
                          <!-- Submit Button -->
                          <button type="submit" class="btn btn-primary" onclick="return verif_art_manaet_inputs()">submit</button>
